...
<div className={`shadow-sm p-4 flex items-center gap-4 relative overflow-hidden ${darkMode ? 'bg-gradient-to-r from-blue-900 to-blue-900' : 'bg-gradient-to-r from-blue-500 to-blue-500'}`}>
